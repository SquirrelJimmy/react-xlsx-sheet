...
var X = _interopRequireWildcard(require("xlsx"));
...
function (_PureComponent) {
  ...
  function ExportSheet(props) {
    ...
    _this.exportFile = function () {
      ...
      var ws = (_XLSX$utils = XLSX.utils)[utilsName].apply(_XLSX$utils, _toConsumableArray(value));

      var wb = XLSX.utils.book_new();
      XLSX.utils.book_append_sheet(wb, ws, formatName);
      XLSX.writeFile(wb, "".concat(formatName, ".").concat(extName));
    };
  ...
  _createClass(ExportSheet, [{
    ...
    value: function toRightDate() {
      ...
      if (dataType === 'Array-of-Arrays') {
        ...
        return [header, _objectSpread({}, headerOption)];
      }
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", _extends({}, className ? {
        className: className
      } : {}, {
