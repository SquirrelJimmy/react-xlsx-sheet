...
t.exports=function(t){return null==t?void 0===t?"[object Undefined]":"[object Null]":i&&i in Object(t)?n(t):c(t)}},function(t,e,r){var o=r(4),n=r(10)
...
function p(t){return(p="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function s(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{},o=Object.keys(Object(r))
...
return r}}(t)||function(t){if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))return Array.from(t)}(t)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance")}()}function d(t,e){return!e||"object"!==p(e)&&"function"!=typeof e?function(t){if(void 0!==t)return t
...
o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}function v(t,e,r){return e&&j(t.prototype,e),r&&j(t,r),t}function h(t,e){return(h=Object.setPrototypeOf||function(t,e){return t.__proto__=e,t})(t,e)}var S=["xlsx","xlsm","xlsb","xls","ods","fods","csv","txt","sylk","html","dif","dbf","rtf","prn","eth"],x=function(t){function e(t){var a
if(function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,e),(a=d(this,m(e).call(this,t))).XLSX=a.props.xlsx,a.toSheet=function(){var t,e,r=a.state,o=r.utilsName,n=r.dataSource
...
var i=a.toRightDate()
return(e=a.XLSX.utils)[o].apply(e,b(i))}},a.exportFile=function(){var t=a.toSheet(),e=a.props,r=e.extName,o=e.fileName,n=e.isRequiredNameDate,c=e.fileDate,i=(n?"".concat(o,"__").concat(c):o).replace(/\\|\/|\?|\*|\[|\]|\s|\{|\}/g,"_"),u=a.XLSX.utils.book_new()
a.XLSX.utils.book_append_sheet(u,t,i),a.XLSX.writeFile(u,"".concat(i,".").concat(r))},!S.includes(t.extName))throw new Error("extName not suport")
if(a.importType={"Array-of-Arrays":"aoa_to_sheet","Array-of-Object":"json_to_sheet","Table-Node-Selector":"table_to_sheet"},!a.importType[t.dataType])throw new Error('dataType must be oneOf ["Array-of-Arrays", "Array-of-Object"]')
return a.state={utilsName:a.importType[t.dataType],dataSource:t.dataSource},a}return function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function")
t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&&h(t,e)}(e,o["PureComponent"]),v(e,null,[{key:"getDerivedStateFromProps",value:function(t,e){return t.dataSource!==e.dataSource?{dataSource:t.dataSource}:null}}]),v(e,[{key:"toRightDate",value:function(){var t=this.props,o=t.header,e=t.headerOption,r=this.state.dataSource,n=this.props.dataType,c=[],i=[]
...
var r={}
return o.map(function(t){return r[t.title]=e[t.dataIndex],!!c.includes(r)||(c.push(r),i.includes(t.title)||i.push(t.title),!0)}),!0}),[c,s({header:i},e)]):"Array-of-Arrays"===n?(r.map(function(t){if(!Array.isArray(t))throw new Error("dataSource must be like Array-of-Arrays type")
return null}),[r,s({},e)]):[]}},{key:"render",value:function(){var t,e=this,r=this.props,o=r.children,n=r.isDOMElement
...
return t}}]),e}()
x.propTypes={dataType:c.a.oneOf(["Array-of-Arrays","Array-of-Object","Table-Node-Selector"]),header:c.a.arrayOf(c.a.shape({title:c.a.string,dataIndex:c.a.string})),headerOption:c.a.shape({dateNF:c.a.string,skipHeader:c.a.bool}),dataSource:c.a.array,fileName:c.a.string,fileDate:c.a.string,extName:c.a.oneOf(S),isRequiredNameDate:c.a.bool,isDOMElement:c.a.bool.isRequired,xlsx:c.a.object.isRequired,tableElement:c.a.element},x.defaultProps={dataType:"Array-of-Object",header:[],headerOption:{skipHeader:!1,dateNF:"FMT 14"},dataSource:[],extName:"xlsx",isRequiredNameDate:!0,fileName:"",isDOMElement:!0,fileDate:(new Date).toLocaleDateString()}
var O=x
